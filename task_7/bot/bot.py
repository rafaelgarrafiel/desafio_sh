# -*- coding: utf-8 -*-
# TODO: remover traceback
import os, sys, traceback, logging, configparser
import xlsxwriter

# TODO: remover timedelta, timezone
...
def main(argv):
    ...
    # TODO: recomenda-se criar uma fábrica de aplicação, conforme documentação oficial https://flask.palletsprojects.com/en/2.0.x/tutorial/factory/ 
    app = Flask(__name__)
    handler = RotatingFileHandler('bot.log', maxBytes=10000, backupCount=1)
    handler.setLevel(logging.INFO)
    app.logger.addHandler(handler)

    # TODO: por segurança, é recomendado levar a string de conexão para o arquivo config.ini
    ...
    # TODO: variável task1_instance não utilizada
...
def task1(db):
    ...
    # TODO: setar os campos do select
